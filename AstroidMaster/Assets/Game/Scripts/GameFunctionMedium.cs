...
public class GameFunctionMedium : MonoBehaviour
{
    int firstValue, secondValue, thirdValue, tempValue, finalAnswer;
    private int Answer1, Answer2, Answer3, score = 0;
    public TMP_Text FirstValue, SecondValue, ThirdValue, Ans_1, Ans_2, Ans_3, Ans_4, Answer_Space, TotalScore, Message;
    ...
    private void CalculateFunction()
    {
        ...
        finalAnswer = firstValue + secondValue + thirdValue;
