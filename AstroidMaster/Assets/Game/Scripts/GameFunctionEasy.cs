...
public class GameFunctionEasy :  MonoBehaviour
{
    int firstValue, secondValue, tempValue, finalAnswer;
    private int Answer1, Answer2, Answer3, score = 0 ;
    public TMP_Text FirstValue, SecondValue, Ans_1, Ans_2, Ans_3, Ans_4, Answer_Space, TotalScore, Message;
